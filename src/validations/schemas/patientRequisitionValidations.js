...
export const createPatientRequisitionSchema = Joi.object({
    ...
    previous_transfusion: Joi.boolean()
        .required()
        .messages({
    ...
    previous_transfusion_reaction: Joi.boolean()
        .required()
        .messages({
